...
func Pipe3[A, B, C, D any](
	...
	return op3.Apply(op2.Apply(op1.Apply(ob)))
}
...
func Pipe4[A, B, C, D, E any](
	...
	return op4.Apply(op3.Apply(op2.Apply(op1.Apply(ob))))
}
...
func Pipe5[A, B, C, D, E, F any](
	...
	return op5.Apply(op4.Apply(op3.Apply(op2.Apply(op1.Apply(ob)))))
}
...
func Pipe6[A, B, C, D, E, F, G any](
	...
	return op6.Apply(op5.Apply(op4.Apply(op3.Apply(op2.Apply(op1.Apply(ob))))))
}
...
func Pipe7[A, B, C, D, E, F, G, H any](
	...
	return op7.Apply(op6.Apply(op5.Apply(op4.Apply(op3.Apply(op2.Apply(op1.Apply(ob)))))))
}
...
func Pipe8[A, B, C, D, E, F, G, H, I any](
	...
	return op8.Apply(op7.Apply(op6.Apply(op5.Apply(op4.Apply(op3.Apply(op2.Apply(op1.Apply(ob))))))))
}
...
func Pipe9[A, B, C, D, E, F, G, H, I, J any](
	...
	return op9.Apply(op8.Apply(op7.Apply(op6.Apply(op5.Apply(op4.Apply(op3.Apply(op2.Apply(op1.Apply(ob)))))))))
}
